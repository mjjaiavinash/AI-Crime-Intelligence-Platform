...
import SupervisorSidebar from '@/components/layout/sidebars/SupervisorSidebar'
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface">
      ...
      <div className={`fixed inset-y-0 left-0 z-30 lg:relative lg:z-auto transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <SupervisorSidebar collapsed={collapsed} onToggle={() => setCollapsed(!collapsed)} onClose={() => setOpen(false)} />
      </div>
