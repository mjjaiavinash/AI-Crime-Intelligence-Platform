...
export default function LoginPage() {
  ...
  const ROLES = [
    { label: 'Select your role…', username: '' },
    { label: 'Investigator', username: 'invest1' },
    { label: 'Crime Analyst', username: 'analyst1' },
    { label: 'Supervisor', username: 'supervisor1' },
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="block text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em]">Who are you?</label>
              <div className="flex items-center gap-3 px-4 py-3.5 rounded-xl border border-white/[0.08] bg-white/[0.04] hover:border-white/[0.14] transition-all duration-200">
                ...
                <select className="flex-1 bg-transparent text-sm text-white outline-none" defaultValue="">
                  {ROLES.map((r) => (
                    <option key={r.label} value={r.username} className="bg-slate-900">{r.label}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            {/* Username field */}
            <div className="space-y-1">
              <label className="block text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em]">Username</label>
              <div className={`flex items-center gap-3 px-4 py-3.5 rounded-xl border transition-all duration-200 ${
                ...
                <svg className={`w-4 h-4 shrink-0 transition-colors ${focused === 'username' ? 'text-blue-400' : 'text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-1">
              ...
              <div className={`flex items-center gap-3 px-4 py-3.5 rounded-xl border transition-all duration-200 ${
                ...
                <svg className={`w-4 h-4 shrink-0 transition-colors ${focused === 'password' ? 'text-blue-400' : 'text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                />
                <button type="button" onClick={() => setShowPw(!showPw)} className="text-slate-600 hover:text-slate-300 transition-colors shrink-0">
                  {showPw
